 ...
 */
GTN.ui.containerFns.simpleImpl = (function ($, util, Positioning) {
...
//        });
    ...
    $(data.data.el).on('mousedown touchstart', function (e) {
        ...
        $(data.data.el).on("mousemove touchmove", function (e) {
          ...
          var dat = GTN.util.rotateVector(0, moveX - pageX, moveY - pageY);
          pageX = moveX;
          pageY = moveY;
...
GTN.util.di.register("GTN.ui.containerFns.simpleImpl", ["$", "GTN.util", "GTN.models.Positioning"], GTN.ui.containerFns.simpleImpl);
