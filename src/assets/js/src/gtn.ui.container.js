GTN.ui.Container = function (ko, $,util, Positioning, Perspective, ElementUpdater) {
    ...
    var ctor = function (containerEl) {
        ...
        this._postProcess = function(data, el, ctx, cb){
            ...
            if (data.children && data.children.length) {
                ...
                return data.children.forEach(function (ch) {
                    ...
                    var Container = GTN.util.di.get("GTN.ui.Container");
                    new Container(el)
        ...
        this.addChild = function (ctx, child, finalCb) {
            ...
            if(ctx.containerEl){
                ...
                cb = function() {
                    //console.log("GTN.ui.container: final cb",containerEl);
                    var args = [];
...
GTN.util.di.register("GTN.ui.Container", ["ko", "$",  "GTN.util", "GTN.models.Positioning",  "GTN.models.Perspective", "GTN.services.ElementUpdater"], GTN.ui.Container);
