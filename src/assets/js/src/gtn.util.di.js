GTN.util.Di = function (map) {
    this._map = map || {};
};

GTN.util.Di.prototype.register = function (name, depArray, fn) {
...
GTN.util.Di.prototype.registerCtor = function (name, depArray, ctor) {
    name = name.toLowerCase();
    this._map[name] = {
        depArray: depArray || [],
        ctor: ctor
...
GTN.util.Di.prototype.construct = function(constructor, args) {
    function F() {
...
GTN.util.Di.prototype.get = function (name) {
    name = name.toLowerCase();
    var self = this;
...
GTN.util.Di.prototype.registerCtorInit = function(name, depArray, fn){
    this.register(name, depArray, fn);
    this.get(name);
};

/// return a new instance of GTN.util.Di without affecting the old
GTN.util.Di.prototype.clone = function () {
    var newMap = {};
