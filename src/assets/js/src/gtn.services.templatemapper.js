GTN.services.templateMapper = function (util, Position) {
...
GTN.util.di.register("GTN.services.templateMapper", ["GTN.util", "GTN.models.Position"], GTN.services.templateMapper);
